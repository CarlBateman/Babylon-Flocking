// https://github.com/pex-gl/pex/blob/dev/src/pex/geom/Octree.js
// https://github.com/pex-gl/pex/blob/f5af053e6206ac31832c5527b7d676e42a96c016/src/pex/geom/Octree.js
// https://vorg.github.io/pex/docs/pex-geom/Octree.html

//define(['pex/geom/Vec3'],
//  function (Vec3) {
...
Octree.Cell.prototype.findNearbyPoints = function (p, r, result, options) {
  if (this.points.length > 0 && this.children.length === 0) {
    for (var i = 0; i < this.points.length; i++) {
      var dist = this.points[i].distance(p);
      // here here add distance to result
      if (dist <= r) {
        if (dist === 0 && options.notSelf)
          continue;
